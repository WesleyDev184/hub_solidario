...
class _CreateBeneficiaryPageState extends State<CreateBeneficiaryPage> {
  ...
  void _createBeneficiary() async {
    ...
    final createBeneficiaryDTO = CreateBeneficiaryDTO(
    ...
    final result = await _beneficiaryController.createBeneficiary(
      ...
      result.fold(
        ...
        (error) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                _beneficiaryController.error ?? 'Erro ao criar beneficiário',
              ),
